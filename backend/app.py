...
:root { --rx-indigo: #4f46e5; --rx-indigo-600: #4338ca; --rx-sky: #0ea5e9; --rx-emerald: #10b981; --rx-white: #ffffff; --rx-text: #e6e6f0; --rx-text-dim: #b7bfd6; --rx-border: rgba(255,255,255,0.22); --rx-bg: radial-gradient(1200px 600px at 10% -10%, rgba(79,70,229,0.10) 0%, rgba(14,165,233,0.08) 40%, transparent 70%), radial-gradient(900px 500px at 110% 10%, rgba(16,185,129,0.12) 0%, transparent 60%), #0b1220; }
...
.rx-header-container { display:flex; justify-content: space-between; align-items:center; margin-bottom: 5px; }
...
# --- SESSION STATE INIT ---
for key, default in {
    "messages": [{"role": "assistant", "content": "Welcome to RecallX — drop a file and ask anything about it."}],
    "sources": [],
    "show_settings": os.getenv("SHOW_SETTINGS", "0"),
    "mode": "default",
    "personal_responses": [],
    "logged_in": False,
    "user": None,
    "chunks": [],
    "embs": np.empty((0,384), dtype=np.float32)
}.items():
